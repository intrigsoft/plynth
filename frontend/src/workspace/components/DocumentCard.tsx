...
export function DocumentCard({
  ...
  return (
    <div className="card card--hover" style={{ overflow: 'hidden', cursor: 'pointer', position: 'relative', zIndex: menu ? 60 : undefined }} onClick={() => !editing && onOpen()}>
      {/* thumbnail */}
      ...
      <div style={{ padding: '12px 14px 13px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 12, color: doc.desc ? 'var(--muted-2)' : 'var(--faint)', marginTop: 3, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
